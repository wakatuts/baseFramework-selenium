...
public class SelectImpl extends ElementImpl implements Select{
     ...
     */
    public SelectImpl(WebElement element, String elementName) {
        super(element, elementName);
    }
    
    public SelectImpl(By by, String elementName) {
    	super(by, elementName);
    }
    
    private void initiateSelect() {
    	initiateElement();
    	this.innerSelect = new org.openqa.selenium.support.ui.Select(element.get());
    }
